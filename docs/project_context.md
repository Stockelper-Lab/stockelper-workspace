...
sections_completed: ['technology_stack', 'language_rules', 'architectural_decisions', 'service_boundaries', 'ux_patterns', 'common_pitfalls']
---
...
### Unified Data Model for Backtesting & Portfolio Recommendations
...
- `IN_PROGRESS`: Agent is processing request
- `COMPLETED`: Agent finished successfully, results available
...
### Infrastructure & Database Locations
...
- **Purpose:** Stores backtesting results, portfolio recommendations, user data
...
- Processes backtesting requests (5-10 minutes)
- Writes results to PostgreSQL on AWS t3.medium
- Manages status transitions

**Knowledge Graph Builder (stockelper-kg):**
- Neo4j graph construction
- Event extraction from DART disclosures
